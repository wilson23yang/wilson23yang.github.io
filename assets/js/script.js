...
var CodePenEmbed = {
    width: "100%", init: function () {
        ...
        for (var t = e.length - 1; t > -1; t--) {
            ...
            var r = this._buildURL(n), i = this._buildIFrame(n, r);
        ...
        for (var r = 0, i = n.length; r < i; r++) {
            name = n[r].name;
            name.indexOf("data-") === 0 && (t[name.replace("data-", "")] = n[r].value);
        }
        return t
        ...
        var t = this._getHost(e), n = e.user ? e.user : "anon", r = "?" + this._getGetParams(e),
        ...
        var eventMethod = window.addEventListener ? "addEventListener" : "attachEvent",
            eventListener = window[eventMethod], messageEvent = eventMethod == "attachEvent" ? "onmessage" : "message";
